...
- **Dashboard** — resources, live venture valuation (shown as *potential* value × an **evidence-coverage %** the team earns by proving their model, so an unproven idea starts low and climbs), performance dimensions, and a warning list of high-importance untested assumptions.
