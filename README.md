...
- **AI Assist Log** — turns AI *use* into AI *evaluation*. Logging requires **both the AI's claim and how you'll verify it** (the AUDIT "Independent test" step) — you can't log AI you won't check. The round score's **AI-verification** component then rewards the share of AI uses you actually evaluated (verified / rejected / modified), **not** how much AI you use — and it's neutral (`n/a`) for teams that don't use AI, so verification, not usage, is what earns credit.
