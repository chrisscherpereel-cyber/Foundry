...
- **Founder & Team** — a realistic model of the founding team:
  - **Weekly founder time** — the founder works a long week (40–80 hours by difficulty), but **productivity drops past 40 hours**, so effective time grows slowly. Time **resets each round** — unused hours are **lost**, never accumulated — and is split between **running the business** (experiments/canvases), **training**, and **managing hires**.
