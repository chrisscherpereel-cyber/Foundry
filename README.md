...
- **Founder Skills** — the team's structured capabilities (Customer Research, Design & Prototyping, Technical/Engineering, Sales & Growth, Finance & Unit Economics, Operations, Responsible Innovation). Each skill has a **defined meaning** and a **real effect** (it raises the matching performance dimension). Starting levels come from the founder card; teams **train skills up** by investing founder-hours (higher levels cost more).
